...
public class StringsUtil {
    ...
    private static Proposition setPropositionDefaultValues(char propositionChar, int propositionSize, int currentProposition) {
    ...
    public static ArrayList propositionList(String equation) { //Devolve a lista de propositivos preenchidos com os valores Default
        ...
        for (int i = 0; i < stringSize; i++) {
            propositionsInArray.add(setPropositionDefaultValues(propositions.charAt(i), propositionSize, currentProposition));
            currentProposition--;
        }
